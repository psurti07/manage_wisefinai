                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    @if($offers)
                                        ...
                                        <tr>
                                            <td>         
                                                <img src="{{ asset('public/upload/banks/'.$offer->bank_image) }}" width="80">
                                            </td>
                                            <td>
                                                <div>
...
<script>
    ...
    function deleteRemark(remarks_id){
        swal({
            ...
            if (willDelete) {
                $.ajax({
                    url: 'https://manage.WiseFinAI.com/selfapply/applications-details/delete-remarks',
                    type: 'POST',
    ...
    function updProcessStep(userId, appId){
        swal({
            ...
            if (willDelete) {
                $.ajax({
                    url: 'https://manage.WiseFinAI.com/selfapply/applications-details/update-process',
                    type: 'POST',
